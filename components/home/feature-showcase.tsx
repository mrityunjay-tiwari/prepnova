...
const features = [
  ...
  },
  {
    ...
    description: "Track your progress over time and get detailed insights on your performance.",
    image: "https://ik.imagekit.io/mrityunjay/prepnova/ChatGPT%20Image%20May%202,%202026,%2003_28_14%20PM.png",
  },
];
...
export function FeatureShowcase() {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto p-6 md:p-12 font-sans bg-white dark:bg-inherit text-slate-900 dark:text-inherit rounded-3xl">
      ...
      <Headings subtitle="Post Interview" title="Analysis and Progress Tracking" />
              ...
              <div className="mt-3 md:mt-4 flex flex-col">
                <h3
                  className={cn(
                    ...
                    isActive ? "text-slate-900 dark:text-white" : "text-slate-900 dark:text-zinc-400"
                  )}
                >
                  {feature.title}
                </h3>
                ...
                <p
                  className={cn(
                    ...
                    isActive ? "text-slate-600 dark:text-zinc-400" : "text-slate-400 dark:text-zinc-600"
                  )}
                >
                  {feature.description}
                </p>
