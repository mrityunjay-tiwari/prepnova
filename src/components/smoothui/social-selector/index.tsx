...
const defaultPlatforms: Platform[] = [
  {
    ...
    url: "https://x.com/mrityunjay_18",
  },
  {
    name: "LinkedIn",
    domain: "linkedin",
    icon: <FaLinkedinIn className="h-5 w-5" />,
    url: "https://linkedin.com/in/mrityunjay-tiwari-a81275190/",
  },
  {
    name: "Peerlist",
    domain: "peerlist.io",
        ...
        <div className="flex items-center justify-center">
          <div className="relative flex w-fit items-center justify-center gap-4">
            ...
            <motion.div
              ...
              className="absolute inset-0 z-0 h-9 w-9 rounded-full border border-border bg-muted"
              initial={false}
